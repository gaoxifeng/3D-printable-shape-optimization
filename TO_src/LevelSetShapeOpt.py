...
class LevelSetShapeOpt():
    def __init__(self, *, h=1, dt=1.5, tau=1e-8, maxloop=200, maxloopLinear=1000, tolx=1e-3, tolLinear=1e-2, outputInterval=1, outputDetail=False):
        # self.device = 'cpu'
        self.h = h
        self.dt = dt
        self.tau = tau
    ...
    def initialize_phi(phiFixedTensor, blockRes, f=None, evenOdd=1, scale=.5):
